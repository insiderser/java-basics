...
public class DummyStudentGradebooksProvider {

    public static StudentGradebook[] get() {
        return new StudentGradebook[]{
            ...
            new StudentGradebook("Fifth Oojigroi Shrt", "ІП-0105", 1,
                new Exam[]{new Exam("Java", 1f), new Exam("Psychology", 3.2f)}, 2.1f),
